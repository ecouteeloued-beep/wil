...
export const MOCK_COMPLAINTS_SEED: EnhancedGrievance[] = [
  // 1. IN_PROGRESS
  {
    ...
    status: 'قيد المعالجة',
    priority: 'متوسط',
    fullName: 'عبد الرحمن مسعودي',
    phone: '0661245890',
    nin: '198839010045230012',
    ...
    subject: 'انقطاع متكرر لشبكة الإنارة العمومية بحي 19 مارس تكسبت',
  ...
  // 2. NEW
  {
    ...
    status: 'جديد',
    priority: 'عادي',
    fullName: 'فاطمة الزهراء قدور',
    phone: '0663481290',
    nin: '199039020018450034',
    applicantDaira: 'قمار',
    applicantMunicipality: 'تغزوت',
    applicantNeighborhood: 'قرية غمرة الفلاحية',
    grievanceDaira: 'قمار',
  ...
  // 3. WAITING_CITIZEN
  {
    ...
    priority: 'متوسط',
    fullName: 'عمار التجاني لعماري',
    phone: '0668923411',
    nin: '197539030055120088',
    applicantDaira: 'الدبيلة',
    applicantMunicipality: 'الدبيلة',
    applicantNeighborhood: 'حي النصر',
  ...
  // 4. WAITING_REVIEW
  {
    ...
    priority: 'عاجل',
    fullName: 'بلقاسم حواشني',
    phone: '0662719430',
    nin: '198239010067330051',
    applicantDaira: 'الوادي',
    applicantMunicipality: 'كوينين',
    applicantNeighborhood: 'حي البساتين كوينين',
    grievanceDaira: 'الوادي',
  ...
  // 5. RESOLVED
  {
    ...
    status: 'تمت المعالجة',
    priority: 'متوسط',
    fullName: 'محمد الهادي غربي',
    phone: '0665330198',
    nin: '197939020033870029',
    applicantDaira: 'قمار',
    applicantMunicipality: 'قمار',
    applicantNeighborhood: 'قرية سيدي عبد الرحمان',
    grievanceDaira: 'قمار',
  ...
  // 6. CLOSED
  {
    ...
    phone: '0669147285',
    nin: '197039010011240093',
    applicantDaira: 'الوادي',
    applicantMunicipality: 'الوادي',
    applicantNeighborhood: 'حي الأعشاش وسط المدينة',
    grievanceDaira: 'الوادي',
    grievanceMunicipality: 'الوادي',
    category: 'البيئة',
  ...
  // 7. URGENT (Secondary case)
  {
    ...
    status: 'عاجل',
    priority: 'قصوى',
    fullName: 'يوسف العيداني',
    phone: '0667823910',
    nin: '198539040088190045',
    applicantDaira: 'البياضة',
    applicantMunicipality: 'البياضة',
    applicantNeighborhood: 'حي أول نوفمبر',
  ...
  // 8. DUPLICATE (Secondary case)
  {
    ...
    status: 'مكرر',
    priority: 'عادي',
    fullName: 'عبد الكريم زغدي',
    phone: '0661904523',
    nin: '199239010044560076',
    applicantDaira: 'الوادي',
    applicantMunicipality: 'الوادي',
    applicantNeighborhood: 'حي 19 مارس تكسبت',
    grievanceDaira: 'الوادي',
  ...
  // 9. OUT_OF_SCOPE (Secondary case)
  {
    ...
    priority: 'عادي',
    fullName: 'مبروك بن علي',
    phone: '0664287163',
    nin: '198139050073210067',
    applicantDaira: 'الرقيبة',
    applicantMunicipality: 'الرقيبة',
    applicantNeighborhood: 'حي المحطة',
  ...
  // 10. REJECTED (Secondary case)
  {
    ...
    fullName: 'سعيد بلال',
    phone: '0663198450',
    nin: '199539010098430082',
    applicantDaira: 'الوادي',
    applicantMunicipality: 'الوادي',
    applicantNeighborhood: 'حي الصحن',
    grievanceDaira: 'الوادي',
    grievanceMunicipality: 'الوادي',

      ...
      {isOpen && (
        ...
        >
          ...
          {/* =========================================================================
             ...
             ========================================================================= */}
          <div
            className="flex-1 relative flex items-center justify-center py-10 px-4 sm:px-6 bg-[#006233]"
            style={{
              backgroundImage: 'linear-gradient(90deg, rgba(0,98,51,.88) 0%, rgba(0,98,51,.56) 34%, rgba(255,255,255,.08) 50%, rgba(210,16,52,.42) 100%), url("/assets/wilaya-eloued-bg.webp")',

    ...
    <section className="max-w-3xl mx-auto bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden font-tajawal" dir="rtl" aria-live="polite">
      ...
      <div className="p-5 sm:p-7 space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div className="rounded-xl border border-gray-200 bg-gray-50 p-4"><div className="text-xs text-gray-500">الهوية المدنية</div><p className="font-bold text-sm text-gray-800 mt-2">{complaint.birthDate || 'تاريخ الميلاد غير متوفر'} — {complaint.gender || 'الصفة غير متوفرة'}</p></div>
